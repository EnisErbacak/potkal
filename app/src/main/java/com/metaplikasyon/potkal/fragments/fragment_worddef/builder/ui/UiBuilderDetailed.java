...
public class UiBuilderDetailed implements UiBuilder {
    ...
    public UiBuilderDetailed(Context context, String setName) {
...
//        ll.removeAllViews();
    ...
    public void createView(LinearLayout ll, ArrayList<String> keys, JSONObject jObj) {
        ...
        for(int i=0;i<keys.size();i++) {
            ...
            ll.addView(new LlContainerMain(context, new ClContainerUpper(context, word.getWrd(), word.getLang(), word.getPts() )
                                               , new LlContainerLower(context, word.getKind(), word.getDef(), word.getExmp())));
        }
    }
